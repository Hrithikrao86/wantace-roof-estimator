...
const config = {
  ...
  questions: [
    { key: 'roof_area', label: 'Roughly how big is your roof?', type: 'number', unit: 'sq ft', required: true, min: 300, max: 12000, active: true, options: [] },
...
async function seed() {
  ...
  await Config.updateOne({ config_version: 3 }, { $set: { active: true } });
